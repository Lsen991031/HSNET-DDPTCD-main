CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=8 --master_port 25961 main.py \
        --arch resnet50 --num_segments 8 --seed 1993 --wandb \
        --gd 20 --lr 2e-4 --lr_steps 20 30 --epochs 100 --fine_tune_epochs 40 --training --testing \
        --train_batch-size 2 --test_batch-size 2 --exemplar_batch-size 2 -j 8 \
        --start_task 0 --exp 1209000 --exemplar --nme \
